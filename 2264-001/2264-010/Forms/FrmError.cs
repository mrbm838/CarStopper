    ...
    public partial class FrmError : UIForm
    {
        ...
        private void btn_Confirm_Click(object sender, EventArgs e)
        {
            ...
            if (listView1.SelectedItems[0].Index == 0)
            {
                ...
                baceClass1.m_Status = Base.Status.动作;
            }
        ...
        public void ShowErr(ref Base baceClass, string str, int reTrystep, int nextStep, string solution)
        {
            baceClass1 = baceClass;
            reTryStep1 = reTrystep;
            nextStep1 = nextStep;
            baceClass1.m_Status = Base.Status.错误;
        ...
        public void ShowErr(ref Base baceClass, string errCode, int reTrystep, int nextStep)
        {
            baceClass1 = baceClass;
            reTryStep1 = reTrystep;
            nextStep1 = nextStep;
